...
// kafka-topics --zookeeper localhost:2181 --create --topic emails --replication-factor 1 --partitions 3


// Key/Value consumer
// Auto commit disabled
public class EmailRebalanceConsumer {
